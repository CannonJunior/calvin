...
@mcp.tool()
async def get_earnings_sentiment_summary(
    symbol: str,
    earnings_date: str
) -> Dict[str, Any]:
    """
    Get sentiment analysis summary for earnings
    ...
    """
    # This would integrate with the sentiment analysis server
    ...
    return {
        ...
        "sentiment_analysis": {
            "pre_earnings_sentiment": {
                "score": 0.65,
                "category": "Positive",
                "sources": ["analyst_reports", "news_articles", "social_media"]
            },
            "post_earnings_sentiment": {
                "score": 0.72,
                "category": "Positive",
                "sources": ["earnings_call", "press_release", "analyst_reactions"]
            },
